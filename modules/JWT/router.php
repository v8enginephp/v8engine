...
$router->group(["prefix" => "api/user"], function () use ($router) {
    ...
    $router->post("login", [UserApiController::class, "login"])->name("login");
    $router->post("register", [UserApiController::class, "register"])->name("register");
    $router->post("forget", [UserApiController::class, "forget"])->name("forget");
    $router->post("reset", [UserApiController::class, "reset"])->name("reset");
...
//    $router->get("auth", [UserWebController::class, "auth"])->middleware(NonWebAuthenticate::class);
    $router->get("login", [UserWebController::class, "login"])->middleware(NonWebAuthenticate::class)->name("get.login");
    $router->get("forget", [UserWebController::class, "forget"])->middleware(NonWebAuthenticate::class)->name("get.forget");
    $router->get("register", [UserWebController::class, "register"])->middleware(NonWebAuthenticate::class)->name("get.register");
    $router->get("reset", [UserWebController::class, "reset"])->middleware(NonWebAuthenticate::class)->name("get.reset");
