...
;(function (window, $, module) {
    ...
    var ElementRect = (function () {
        ...
        _createClass(ElementRect, [{
            ...
            value: function distanceToFarthestCorner(_ref) {
                ...
                return Math.max(ElementRect.euclideanDistance({x: x, y: y}, {
                    x: 0,
                    y: 0
                }), ElementRect.euclideanDistance({x: x, y: y}, {
                    x: this.width,
                    y: 0
                }), ElementRect.euclideanDistance({x: x, y: y}, {
                    x: 0,
                    y: this.height
                }), ElementRect.euclideanDistance({x: x, y: y}, {x: this.width, y: this.height}));
            }
    ...
    var _touchEvents = (function () {
        return window.navigator.msPointerEnabled ? window.PointerEvent ? {
            down: 'pointerdown',
            up: 'pointerup'
        } : {down: 'MSPointerDown', up: 'MSPointerUp'} : {down: 'touchstart', up: 'touchend'};
    })();
