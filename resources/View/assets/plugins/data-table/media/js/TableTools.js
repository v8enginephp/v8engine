 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    ...
    TableTools.BUTTONS = {
        ...
        "print": $.extend({}, TableTools.buttonBase, {
            "sInfo": "<h6>نمایش چاپ</h6><p> " + "<h4 style='direction:rtl'>برای خروج کلید Escape را فشار دهدید!</h4>	" +
                "<a onclick='window.print();' href='#'><img src='media/images/print.png' /></a>	",
            "sMessage": null,
            "bShowAll": true,
            "sToolTip": "چاپ",
 ...
 */
     ...
     */
    TableTools.DEFAULTS = {
        "sSwfPath": "http://localhost/modiran/assets/plugins/data-table/media/swf/copy_csv_xls_pdf.swf",
        "sRowSelect": "none",
        "sSelectedClass": null,
        "fnPreRowSelect": null,
        "fnRowSelected": null,
